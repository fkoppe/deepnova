...
static const Dark_Library DEEP_INFO_LIBRARY_DEEPNOVA = { "deepnova", DARK_VERSION_MAKE(___DEEP_VERSION_MAJOR, ___DEEP_VERSION_MINOR, ___DEEP_VERSION_STAGE, ___DEEP_VERSION_PATCH), ___DARK_CONFIGURATION, DARK_CONSOLE_COLOR_BBG_CYAN };
